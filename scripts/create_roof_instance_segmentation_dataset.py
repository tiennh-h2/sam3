...
raw_data_dir = "/home/tien.nguyen/workspace/project/common/data/nice/cropped_elevation_dataset"
raw_test_data_dir = "/home/tien.nguyen/workspace/project/common/data/nice/cropped_test_elevation_dataset"
save_path = "/home/tien.nguyen/workspace/project/common/data/nice/cropped_elevation_dataset_roof_segmentation_for_sam3"
...
for task in os.listdir(raw_data_dir):
    ...
    roof_anns = [a for a in coco["annotations"] if a["category_id"] == ROOF_CATEGORY_ID]
