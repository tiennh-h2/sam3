...
save_path = "/home/tien.nguyen/workspace/project/common/data/nice/cropped_full_dataset_roof_houseboundary_entrance_bathroom_segmentation_for_sam3"
...
for task in os.listdir(raw_data_dir):
    ...
    chosen_anns = [a for a in coco["annotations"] if a["category_id"] in [SPECIAL_AREA_ID, ROOF_CATEGORY_ID, HOUSE_BOUNDARY_CATEGORY_ID]]
